    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valores_registrados', models.BooleanField(default=False)),
                ('valores_nombre_piscina', models.ForeignKey(help_text='Nombre_Piscina', on_delete=django.db.models.deletion.CASCADE, to='piscinas.nombre_piscina', verbose_name='nombre_piscina')),
            ],
        ),
    ]
